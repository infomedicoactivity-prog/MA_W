        ...
        <div className="max-w-4xl mx-auto">
          <Card className="shadow-xl">
            <CardContent className="p-8 md:p-12">
              ...
              <div className="text-center py-8" data-testid="contact-section">
                <div className="mb-6">
                  <Building2 className="w-16 h-16 text-medical-blue-600 mx-auto mb-4" />
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Ready to Connect?</h3>
                  <p className="text-gray-600 mb-6">Submit your collaboration request and we'll match you with qualified healthcare professionals.</p>
                </div>
                <a 
                  href="https://docs.google.com/forms/d/e/1FAIpQLSedrY90Sxkf7cPYxSijuJ9MiHZdWhn-VOunArJVWYG2XGToEQ/viewform?usp=sharing&ouid=115535487236519249702"
                  target="_blank"
                ...
                <p className="text-sm text-gray-500 mt-4">
                  Opens in a new tab • Takes 3-5 minutes to complete
                </p>
              </div>
            </CardContent>
          </Card>
