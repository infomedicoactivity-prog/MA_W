      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Connecting healthcare industry and doctors for meaningful marketing, research, and collaboration opportunities that advance patient care.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/companies" className="text-gray-300 hover:text-white transition-colors" data-testid="footer-link-companies">For Companies</Link></li>
              <li><Link href="/doctors" className="text-gray-300 hover:text-white transition-colors" data-testid="footer-link-doctors">For Doctors</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors" data-testid="footer-link-privacy">Privacy Policy</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors" data-testid="footer-link-terms">Terms of Service</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors" data-testid="footer-link-cookies">Cookie Policy</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors" data-testid="footer-link-compliance">Compliance</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-300" data-testid="copyright-text">
            © 2024 MedicoActivity. All rights reserved. | Bridging Healthcare Excellence
          </p>
        </div>
      </div>
    </footer>
